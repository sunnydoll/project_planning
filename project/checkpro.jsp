...
<form id="checkproFrm" name="checkproFrm" method="get" action="">
	...
	<tr>
		...
		<div align="center">
		  <table width="660" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>查看计划</strong></div></td>
            </tr>
            <tr>
              <td align="center">
              <table border="1" align="center">
				<tr>
					...
					<td width="50" align="center">点击调整</td>
				</tr>
				<%
				...
				<tr>
					...
					<td width="50" align="center"><a href="checkprodetails.do?proid=<%=proid%>">调整</a></td>
				</tr>
				<%} %>
				</table>
