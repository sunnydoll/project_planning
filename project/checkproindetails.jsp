<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import="java.util.List, org.czc.planning.model.Project"%>
...
<script type="text/javascript" src="../javascript/form/checkprodetails.js" charset="utf-8"></script>

</head>
<body bgcolor="#000000">
<div style="margin:0px auto;width:780px;">
<form id="checkprodetailsFrm" name="checkprodetailsFrm" method="get" action="">
...
<!--		<td colspan="2" width="77" height="22" background="../images/index_20.gif"><div align="center" class="STYLE3">人员管理</span></div></td>
	...
	<tr>
		...
		<div align="center">
		  <table width="450" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>查看/调整计划</strong></div></td>
            </tr>
            <tr>
              <td><table width="450" border="0" cellpadding="30">
              <%
                  
                  Project pro = (Project)request.getSession(true).getAttribute("prosql");
                  String fin = "";
                  String start = "";
                  String end = "";
                  int proid = pro.getProid();
                  String procontent = pro.getProcontent();
                  String proname = pro.getProname();
                  if(pro.getProfin() == 1)
      			  	fin = "是";
      			  else
      			  	fin = "否";
      			  if(pro.getProstartdate() == null)
      			  	start = "未开始";
      			  else
      				start = pro.getProstartdate().toString();
      			  if(pro.getProenddate() == null)
      				end = "未结束";
      			  else
      				end = pro.getProenddate().toString();
              %>
                <tr>
                  <td><label for="proid">任务号：</label></td>
                  <td><input type="text" id="proid" name="proid" value="<%=proid %>" readonly="true" style="background:none;text-align:center" width="120"></td>
                </tr>
                <tr>
                  <td><label for="proname">对应项目号：</label></td>
                  <td><input type="text" id="proname" name="proname" value="<%=proname %>" style="text-align:center;width:195px"></td>
                </tr>
                <tr>
                  <td><label for="procontent">任务内容：</label></td>
                  <td><textarea id="procontent" name="procontent" rows="8"><%=procontent %></textarea></td>
                </tr>
                <tr>
                  <td><label for="prostartdate">起始时间：</label></td>
                  <td><%=start %></td>
                </tr>
                <tr>
                  <td><label for="proenddate">结束时间：</label></td>
                  <td><%=end %></td>
                </tr>
                <tr>
                  <td><label for="profin">结束与否：</label></td>
                  <td><%=fin %></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td><input type="button" id="btnOK" name="btnOK" value="提交" onClick="return valid()" style="height:30; width:70">&nbsp;&nbsp;&nbsp;&nbsp;
				      <input type="button" id="btnReturn" name="btnReturn" onclick="getback()" value="返回"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
