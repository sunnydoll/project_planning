...
<form id="execheckFrm" name="execheckFrm" method="get" action="">
	...
	<tr>
		...
		<div align="center">
		  <table width="660" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>查看进度</strong></div></td>
            </tr>
            <tr>
              <td align="center">
              <table border="1" align="center">
				<tr>
					...
					<td width="50" align="center">查看进度</td>
				</tr>
				<%
				...
				<tr>
					...
					<td width="50" align="center"><a href="execheckdetails.do?proid=<%=proid%>">查看</a></td>
				</tr>
				<%} %>
				</table>
