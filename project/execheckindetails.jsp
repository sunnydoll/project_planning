...
<form id="execheckdetailsFrm" name="execheckdetailsFrm" method="get" action="">
	...
	<tr>
		...
		<div align="center">
		  <table width="660" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>项目执行情况</strong></div></td>
            </tr>
            <tr>
              <td align="center">
              <table border="1" align="center">
				<tr>
					<td width="70" align="center">任务号</td>
					<td width="100" align="center">对应项目号</td>
					<td width="250" align="center">任务内容</td>
				...
				%>
				<tr>
					<td width="70" align="center"><input type="text" style="width:70px;text-align:center;background:none" align="middle" readonly="true" id="taskid" name="taskid" value="<%=taskid %>"></td>
					<td width="100" align="center"><%=task.getProid() %></td>
					<td width="250" align="center"><%=task.getTaskcontent() %></td>
				...
				<a href="?pageNo=${prePage}&proid=${proid}">上一页</a><a href="?pageNo=${nextPage}&proid=${proid}">下一页</a>
              </td>
            </tr>
          </table>
		</div>
