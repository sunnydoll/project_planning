<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import="org.czc.planning.model.Company"%>
...
<script type="text/javascript" src="../javascript/form/modifycom.js" charset="utf-8"></script>
<title>修改企业</title>
</head>
<body bgcolor="#000000">
<div style="margin:0px auto;width:780px;">
<form id="modifycomFrm" name="modifycomFrm" method="get" action="">
	...
	<tr>
		...
		<div align="center">
		  <table width="450" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>修改企业信息</strong></div></td>
            </tr>
            <%Company com = (Company)request.getSession(true).getAttribute("comsql");
             int comid = com.getComid();
             String comname = com.getComname();
             String comcontent = com.getComcontent();%>
            <tr>
              <td><table width="450" border="0" cellpadding="30">
                <tr>
                  <td><lable for="comid">企业ID：</lable></td>
                  <td><input type="text" style="width:120px;text-align:center;background:none" align="middle" readonly="true" id="comid" name="comid" value="<%=comid %>"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td><label for="comname">企业名称：</label></td>
                  <td><textarea id="comname" name="comname" rows="2"><%=comname %></textarea></td>
                </tr>
                <tr height="30">
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td><label for="comcontent">企业描述：</label></td>
                  <td><textarea id="comcontent" name="comcontent" rows="8"><%=comcontent %></textarea></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td><input type="button" id="btnOK" name="btnOK" value="提交" onClick="return valid()" style="height:30; width:70">&nbsp;&nbsp;
				      <input type="reset" id="btnReset" name="btnReset" value="重置" style="height:30; width:70">&nbsp;&nbsp;
				      <input type="reset" id="btnReturn" name="btnReturn" value="返回" onClick="getback()" style="height:30; width:70"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
