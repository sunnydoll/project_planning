<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import="java.util.List, org.czc.planning.model.AppCom"%>
...
<script type="text/javascript" src="../javascript/form/addcom.js" charset="utf-8"></script>
<title>查看企业</title>
</head>
<body bgcolor="#000000">
<div style="margin:0px auto;width:780px;">
<form id="verifycomFrm" name="verifycomFrm" method="get" action="">
...
<!--		<td colspan="2" width="77" height="22" background="../images/index_20.gif"><div align="center" class="STYLE3">人员管理</span></div></td>
	...
	<tr>
		...
		<div align="center">
		  <table width="680" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>查看企业</strong></div></td>
            </tr>
            <tr>
              <td align="center">
              <table border="1" align="center">
				<tr>
				    <td width="50" align="center">申请号：</td>
					<td width="100" align="center">企业名称:</td>
					<td width="250" align="center">企业描述:</td>
					<td width="100" align="center">管理员ID：</td>
					<td width="100" align="center">管理员姓名：</td>
					<td width="100" align="center">申请时间:</td>
					<td width="50" align="center">点击通过</td>
					<td width="50" align="center">点击删除</td>
					
				</tr>
				<%
				List<AppCom> list = (List<AppCom>)request.getAttribute("list");
				int appcomid = 0;
				String appcomname = "";
				String appcomcontent = "";
				String empcomid = "";
				String empcomname = "";
				String start = "";
				for(AppCom appcom: list) {
					appcomid = appcom.getAppcomid();
					appcomcontent = appcom.getAppcomcontent();
					appcomname = appcom.getAppcomname();
					empcomid = appcom.getEmpcomid();
					empcomname = appcom.getEmpcomname();
					appcomcontent = appcom.getAppcomcontent();
					start = appcom.getAppindate().toString();
				%>
				<tr>
					<td width="70" align="center"><input type="text" style="width:70px;text-align:center;background:none" align="middle" readonly="true" id="comid" name="comid" value="<%=appcomid %>"></td>
					<td width="100" align="center"><%=appcomname %></td>
					<td width="250" align="center"><%=appcomcontent %></td>
					<td width="100" align="center"><%=empcomid %></td>
					<td width="100" align="center"><%=empcomname %></td>
					<td width="100" align="center"><%=start %></td>
					<td width="50" align="center"><a href="verified.do?appcomid=<%=appcomid%>">通过</a></td>
					<td width="50" align="center"><a href="delapp.do?appcomid=<%=appcomid%>">删除</a></td>
				</tr>
				<%} %>
				</table>
