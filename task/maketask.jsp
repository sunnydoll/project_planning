...
<script type="text/javascript" src="../javascript/form/maketask.js" charset="utf-8"></script>
...
<form id="taskmakeFrm" name="taskmakeFrm" method="get" action="">
	...
	<tr>
		...
		<div align="center">
		  <table width="450" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>任务编制</strong></div></td>
            </tr>
            <tr>
              <td><table width="450" border="0" cellpadding="30">
                ...
                <tr><%String p = session.getAttribute("pid").toString(); %>
                  <td><label for="proid">对应项目号：</label></td>
                  <td><input type="text" style="width:70px;text-align:center;background:none" align="middle" readonly="true" id="proid" name="proid" value="<%=p %>"></td>
                </tr>
                <tr height="30">
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td><textarea id="taskcontent" name="taskcontent" rows="8"></textarea></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
