...
<form id="checkempFrm" name="checkempFrm" method="get" action="">
            ...
            <tr>
              ...
              <table border="1" align="center">
				<tr>
					...
					<td width="50" align="center">查看人员</td>
				</tr>
				<%
				...
				<tr>
					...
					<td width="50" align="center"><a href="checkempdetails.do?taskid=<%=taskid%>">查看</a></td>
				</tr>
				<%} %>
				</table>
