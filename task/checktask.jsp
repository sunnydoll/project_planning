...
<form id="checktaskFrm" name="checktaskFrm" method="get" action="">
            ...
            <tr>
              ...
              <table border="1" align="center">
				<tr>
					...
					<td width="50" align="center">点击查看</td>
				</tr>
				<%
				...
				<tr>
					...
					<td width="50" align="center"><a href="checktaskdetails.do?taskid=<%=taskid%>">查看</a></td>
				</tr>
				<%} %>
				</table>
