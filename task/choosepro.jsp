...
<!-- <script type="text/javascript" src="../javascript/form/checkpro.js" charset="utf-8"></script> -->

</head>
<body bgcolor="#000000">
<div style="margin:0px auto;width:780px;">
<form id="chooseproFrm" name="chooseproFrm" method="get" action="">
...
<!--		<td colspan="2" width="77" height="22" background="../images/index_20.gif"><div align="center" class="STYLE3">人员管理</span></div></td>
	...
	<tr>
		...
		<div align="center">
		  <table width="660" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>选择对应项目</strong></div></td>
            </tr>
            <tr>
              <td align="center">
              <table border="1" align="center">
				<tr>
					<td width="70" align="center">项目号</td>
					<td width="100" align="center">项目名称</td>
					<td width="250" align="center">项目内容</td>
					<td width="100" align="center">起始时间</td>
					<td width="100" align="center">结束时间</td>
					<td width="50" align="center">完成与否</td>
					<td width="50" align="center">点击选择</td>
				</tr>
				<%
				...
				%>
				<tr>
					<td width="70" align="center"><input type="text" style="width:70px;text-align:center;background:none" align="middle" readonly="true" id="proid" name="proid" value="<%=proid %>"></td>
					<td width="100" align="center"><%=pro.getProname() %></td>
					<td width="250" align="center"><%=pro.getProcontent() %></td>
					<td width="100" align="center"><%=start %></td>
					<td width="100" align="center"><%=end %></td>
					<td width="50" align="center"><%=fin %></td>
					<td width="50" align="center"><a href="addtaskgetproid.do?proid=<%=proid%>">选择</a></td>
				</tr>
				<%} %>
				</table>
