...
<script type="text/javascript" src="javascript/form/appcom.js" charset="utf-8"></script>
<style type="text/css">
<!--
.STYLE5 {color: #21BADC}
-->
...
<form id="appcomFrm" name="appcomFrm" method="get">
...
<table id="main" width="780" height="801" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td colspan="3" width="94" height="14" >
			<a href=""><img src="images/index_08.gif" alt="" width="94" height="14" border="0"></a></td>
		<td colspan="3">
			<a href=""><img src="images/index_09.gif" width="76" height="14" border="0"></a></td>
		<td colspan="2">
			<a href=""><img src="images/index_10.gif" width="69" height="14" border="0"></a></td>
	</tr>
	<tr>
		<td colspan="3">
	...
	<tr>
		<td colspan="2" rowspan="3">
			<a href=""><img src="images/index_14.gif" alt="" width="279" height="61" border="0"></a></td>
		<td colspan="2">
	...
	<tr>
		...
		<div align="center">
		  <table width="450" border="1" cellpadding="30">
            <tr>
              <td background="images/login_content_title.gif"><div align="center"><strong>填写企业申请信息</strong></div></td>
            </tr>
            <tr>
              <td><table width="450" border="0" cellpadding="30">
                ...
                <tr>
                  <td><label for="appcomname">企业名称：</label></td>
                  <td><textarea id="appcomname" name="appcomname" rows="2"></textarea></td>
                </tr>
                <tr height="30">
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td><label for="appcomcontent">公司描述：</label></td>
                  <td><textarea id="appcomcontent" name="appcomcontent" rows="8"></textarea></td>
                </tr>
                <tr height="30">
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td><label for="empcomid">管理员ID：</label></td>
                  <td><input type="text" id="empcomid" name="empcomid" width="120"></td>
                </tr>                
                <tr>
                  <td><label for="empcomname">管理员姓名：</label></td>
                  <td><input type="text" id="empcomname" name="empcomname" width="120"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td><input type="button" id="btnOK" name="btnOK" value="提交" onclick="return valid()" style="height:30; width:70">&nbsp;&nbsp;&nbsp;&nbsp;
				      <input type="reset" id="btnReset" name="btnReset" value="重置" style="height:30; width:70"></td>
                </tr>                
              </table></td>
            </tr>
          </table>
