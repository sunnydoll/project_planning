...
<script type="text/javascript" src="../javascript/form/highcheckempindetails.js" charset="utf-8"></script>
<title>修改项目管理员信息</title>
</head>
<body bgcolor="#000000">
<div style="margin:0px auto;width:780px;">
<form id="highcheckempdeFrm" name="highcheckempdeFrm" method="get" action="">
	...
	<tr>
		...
		<div align="center">
		  <table width="500" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>修改企业项目管理员信息</strong></div></td>
            </tr>
            <tr>
              <td align="center">
