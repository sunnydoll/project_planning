...
<form id="assempFrm" name="assempFrm" method="get" action="">
            ...
            <tr>
              ...
              <table border="1" align="center">
				<tr>
					...
					<td width="50" align="center">点击分配</td>
				</tr>
				<%
				...
				<tr>
					...
					<td width="50" align="center"><a href="assgettaskid.do?taskid=<%=taskid %>">分配</a></td>
				</tr>
				<%} %>
				</table>
