...
<form id="highcheckempFrm" name="highcheckempFrm" method="get" action="">
	...
	<tr>
		...
		<div align="center">
		  <table width="500" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>企业项目管理员信息</strong></div></td>
            </tr>
            <tr>
              <td align="center">
              <table border="1" align="center">
				<tr>
					<td width="100" align="center">员工ID：</td>
					<td width="100" align="center">登录密码：</td>
					<td width="100" align="center">员工姓名：</td>
					<td width="100" align="center">所属企业号：</td>
					<td width="80" align="center">点击修改</td>
				...
				<tr>
					...
					<td width="100" align="center"><%=comid %></td>
					<td width="80" align="center"><a href="highcheckemp.do?empid=<%=empid%>">修改</a></td>
				</tr>
				<%} %>
				</table>
