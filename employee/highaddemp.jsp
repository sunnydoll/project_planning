<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import="java.util.List, org.czc.planning.model.Company"%>
...
<script type="text/javascript" src="../javascript/form/highaddemp.js" charset="utf-8"></script>
<title>添加人员</title>
</head>
<body bgcolor="#000000">
<div style="margin:0px auto;width:780px;">
<form id="highaddempFrm" name="highaddempFrm" method="get" action="">
	...
	<tr>
		...
		<div align="center">
		  <table width="450" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>添加人员，输入必要信息</strong></div></td>
            </tr>
            <tr>
              <td><table width="450" border="0" cellpadding="30">
                <tr>
                  <%String c = session.getAttribute("cid").toString(); %>
                  <td><label for="comid">对应公司：</label></td>
                  <td><input type="text" style="width:70px;text-align:center;background:none" align="middle" readonly="true" id="comid" name="comid" value="<%=c %>"></td>
                </tr>
                <tr>
                  <td><label for="empid">成员ID：</label></td>
                  <td><input type="text" id="empid" name="empid" width="120"></td>
                </tr>
                <tr height="30">
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td><input type="password" id="empkey" name="empkey" width="120"></td>
                </tr>
                <tr height="30">
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td><input type="password" id="empkeyag" name="empkeyag" width="120"></td>
                </tr>
                <tr height="30">
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td><label for="empname">成员姓名：</label></td>
                  <td><input type="text" id="empname" name="empname" width="120"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
