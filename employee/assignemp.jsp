...
<script type="text/javascript" src="../javascript/form/assemp.js" charset="utf-8"></script>
...
<form id="empassFrm" name="empassFrm" method="get" action="">
	...
	<tr>
		...
		<div align="center">
		  <table width="450" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>分配人员</strong></div></td>
            </tr>
            <tr>
              <td><table width="450" border="0" cellpadding="30">
                <tr><%String s = session.getAttribute("asstaskid").toString(); %>
                  <td><label for="taskid">对应任务：</label></td>
                  <td><input type="text" style="width:70px;text-align:center;background:none" align="middle" readonly="true" id="taskid" name="taskid" value="<%=s %>"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td><label for="empidag">重复ID：</label></td>
                  <td><input type="text" id="empidag" name="empidag" width="120"></td>
                </tr>
                <tr height="30">
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td><input type="button" id="btnOK" name="btnOK" value="提交" onclick="return valid()" style="height:30; width:70">&nbsp;&nbsp;
				      ...
				      <input type="button" id="btnBack" name="btnBack" value="返回" onClick="getback()" style="height:30; width:70"></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
