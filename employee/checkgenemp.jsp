...
<form id="checkgenempFrm" name="checkgenempFrm" method="get" action="">
	...
	<tr>
		...
		<div align="center">
		  <table width="500" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>查看普通员工</strong></div></td>
            </tr>
            <tr>
              <td align="center">
              <table border="1" align="center">
				<tr>					
					...
					<td width="50" align="center">点击修改</td>
				...
				<tr>
					...
					<td width="50" align="center"><a href="modifygenemp.do?empid=<%=empid%>">修改</a></td>
					<td width="50" align="center"><a href="delemp.do?empid=<%=empid%>">删除</a></td>
				</tr>
				<%} %>
				</table>
