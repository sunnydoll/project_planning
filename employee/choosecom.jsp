...
<script type="text/javascript" src="../javascript/form/choosecom.js" charset="utf-8"></script>
<title>选择企业</title>
</head>
<body bgcolor="#000000">
<div style="margin:0px auto;width:780px;">
<form id="choosecomFrm" name="choosecomFrm" method="get" action="">
...
<!--		<td colspan="2" width="77" height="22" background="../images/index_20.gif"><div align="center" class="STYLE3">人员管理</span></div></td>
	...
	<tr>
		...
		<div align="center">
		  <table width="600" border="1" cellpadding="30">
            <tr>
              <td background="../images/login_content_title.gif"><div align="center"><strong>选择要添加管理员的企业</strong></div></td>
            </tr>
            <tr>
              <td align="center">
              <table border="1" align="center">
				<tr>
					<td width="70" align="center">企业号</td>
					<td width="100" align="center">企业名称</td>
					<td width="250" align="center">企业描述</td>
					<td width="100" align="center">加入时间</td>
					<td width="50" align="center">点击添加</td>
				...
				for(Company com: list) {
					...
					comcontent = com.getComcontent();
					start = com.getComindate().toString();
				%>
				<tr>
					<td width="70" align="center"><input type="text" style="width:70px;text-align:center;background:none" align="middle" readonly="true" id="comid" name="comid" value="<%=comid %>"></td>
					<td width="100" align="center"><%=comname %></td>
					<td width="250" align="center"><%=comcontent %></td>
					<td width="100" align="center"><%=start %></td>
					<td width="50" align="center"><a href="highgetaddemp.do?comid=<%=comid%>">添加</a></td>
				</tr>
				<%} %>
				</table>
